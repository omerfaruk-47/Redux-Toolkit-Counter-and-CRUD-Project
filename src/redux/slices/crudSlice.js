...
const crudSlice = createSlice({
  ...
  reducers: {
    addTask: (state, action) => {
      ...
      //2)veriiyi tasklerin arasına ekle
    ...
    editTask: (state, action) => {
      //güncel verilerime sahip oldğumuz elemanı dizideki halini güncelleme
...
//reducer store tanıtmak için export
export default crudSlice.reducer;

//aksiyonları kullanmak için export etmek
